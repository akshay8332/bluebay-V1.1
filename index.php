    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8">
             ...
             <form class="mbr-form" action="server/php/enquiry.php" method="post" data-form-title="enquiry Form" data-form-email="true">
						<input type="hidden" value="true" name="enquiry" >
                        <div class="row row-sm-offset">
                            <div class="col-md-4 multi-horizontal" data-for="name">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7"  for="name-form1-8">Name</label>
                                    <input type="text" class="form-control" data-form-field="Name" name="name" id="name-form1-8" required/>
                                </div>
                            </div>
                            <div class="col-md-4 multi-horizontal" data-for="email">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7"  for="name-form1-8" >Email</label>
                                    <input type="email" class="form-control" data-form-field="Email" name="email" id="name-form1-8"  >
                                </div>
                            </div>
                            <div class="col-md-4 multi-horizontal" data-for="phone">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7"  for="name-form1-8">Phone</label>
                                    <input type="tel" class="form-control" name="phone" data-form-field="Phone" id="name-form1-8" >
                                </div>
                            </div>
							 <div class="col-md-4 multi-horizontal" data-for="trip">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7"  for="name-form1-8">Select trip</label>
                                    <select name="trip" class="form-control" id="trip-form1-8">
                        ...
                        <span><input type="submit" class="btn btn-primary btn-form display-4"/></span>
                    </form>
            </div>
        </div>
    </div><p id="contact"></p>
    ...
    <div class="container">
        <div class="media-container-row content mbr-white">
            ...
            <div class="col-12 col-md-6">
                <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0Dx_boXQiwvdz8sJHoYeZNVTdoWONYkU&amp;q=place_id:ChIJieoA93k-rjsRSweM4Vc_1cY" allowfullscreen=""></iframe></div>
            </div>
        </div>
